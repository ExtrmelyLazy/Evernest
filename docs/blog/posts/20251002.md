...
[Github仓库新建](https://raw.githubusercontent.com/ExtrmelyLazy/Evernest/docs/img/202510/github-repo.jpg){style='width: 30%; height: auto; border: 2px solid #000000;'}  
好，现在我们可以着手构建了。  
在 *Termux* 中，输入  
```bash
...
```
好，它会让你输入 *Password* ，我们打开 *Github* ，点击你的头像，点击 *Settings* ，然后下滑找到 *Developer settings* ，选择 *Personal Access Token* ，然后在展开的菜单里选择 *Tonkens(classic)* ，点击 *Generate new token(classic)* ，通过一下登录验证，在 *Note* 中填写你的用途，把 *Expiration* 设置的长一点，比如 *90 days* 或者 *no expiration* 然后把下面的勾一下 *repo* 和 *workflow* ，点击 *Generate tokens* [截图](https://raw.githubusercontent.com/ExtrmelyLazy/Evernest/docs/img/202510/tokens.png){style="width: 30%; height: auto; border: 2px solid #000000"}
