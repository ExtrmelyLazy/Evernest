...
import postsBg from './posts-bg.jpg'
</script>

<HeroHeader 
  :backgroundImage="postsBg"
  title="如何用Vitepress搭建一个网站"
  description="了解更多我的故事"
/>
...
打开 *Netlify* ，注册完账号后点击 *Import new project* ，选择 *Github* ，登录，选择你的仓库，然后它会跳转回来   
