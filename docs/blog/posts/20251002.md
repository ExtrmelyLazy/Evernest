...
[Github仓库新建](./img/202510/github-repo.jpg){style='width: 30%; height: auto; border: 2px solid #000000;'}  
好，现在我们可以着手构建了。  
在 *Termux* 中，输入  
```bash
...
[截图](./img/202510/tokens.png){style="width: 30%; height: auto; border: 2px solid #000000"}
